...
public class CreateInstructorDemo {
	...
	public static void main(String[] args) {
		...
		try {
			...
			// create the objects
			Instructor theInstructor = new Instructor("sanjay", "acchana", "sanjayacchana@gmail.com");

			InstructorDetail theInstructorDetail = new InstructorDetail("https://www.luv2code.com/youtube",
					"Playing Games");
